...
namespace APIGetListing\Includes;
...
class Autoloader {
	...
	public function autoload( $class_name ) {
		...
		if ( false === strpos( $class_name, 'APIGetListing' ) ) {
			return;
		}
		...
		if ( file_exists( $file_path ) ) {
			...
			error_log( print_r( esc_html( "The file attempting to be loaded at $file_path does not exist." ), true ) );
		}
	}
}
